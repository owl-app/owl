...
namespace FOS\ElasticaBundle\ElasticSearch\Document;

use FOS\ElasticaBundle\ElasticSearch\Document;
use FOS\ElasticaBundle\ElasticSearch\Exception\InvalidException;
use FOS\ElasticaBundle\ElasticSearch\Index;
use FOS\ElasticaBundle\ElasticSearch\Param;
 ...
 */
class AbstractDocument extends Param
{
    /**
     * @var Document
     */
