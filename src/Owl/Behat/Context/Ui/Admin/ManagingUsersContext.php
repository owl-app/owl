...
use Owl\Behat\Element\Admin\TopBarElementInterface;
use Owl\Behat\NotificationType;
use Owl\Behat\Page\Admin\Crud\IndexPageInterface;
use Owl\Behat\Page\Admin\User\CreatePageInterface;
use Owl\Behat\Page\Admin\User\UpdatePageInterface;
use Owl\Behat\Service\NotificationCheckerInterface;
use Owl\Behat\Service\SharedStorageInterface;
use Owl\Component\Core\Model\AdminUserInterface;
use Sylius\Component\Resource\Repository\RepositoryInterface;
use Webmozart\Assert\Assert;

final class ManagingUsersContext implements Context
{
    ...
    /**
     * @When I specify its display name as :displayName
     * @When I do not specify its display name
     */
    public function iSpecifyItsDisplayNameAs($username = null)
    {
        $this->createPage->specifyDisplayName($username ?? '');
    }

    /**
     * @When I change its display name to :displayName
     */
    public function iChangeItsDisplayNameTo($username)
    {
        $this->updatePage->changeDisplayName($username);
    }
     ...
     * @Then /^there should be (\d+) users in the list$/
     */
